...
#let metadata = (
  title: "Unusual Attitudes and Emergencies — Instructional Walkthrough",
  unit: "Instructor Training | Syllabus Walkthrough 12 of 12 — maps to Ab Initio Phase 3, Lesson 4 (E16 content only)",
  author: "C.Moroney",
  version: "v1.0.0",
...
,aim: [
Deliver an instructor-standard ground briefing and in-flight lesson on unusual attitude recovery, in-flight emergencies, and the ADM framework, after observing an IT demonstration, to a standard the IC could use with a real ab-initio student.
]
...
- Apply and teach the ADM framework to a novel, unscripted in-flight scenario
#text(size:12pt)[*Non-Technical Skills*]
- [HF] Brief proprioceptive/vestibular illusion awareness — the body is not a reliable attitude reference — as directly relevant to why unusual attitude recovery must be trained, not just understood intellectually
- [ADM] Model asking "how much time do I have?" first, before proposing a solution, for any novel scenario
]
...
,ground_brief_topics: [
Total time: 25 min IT demonstration + 25 min IC recreation (E16 content only — reduced from the ab-initio source's 35 min, since the E10 recap portion is excluded) \
Equipment required: Aircraft model, whiteboard \

*IT Demonstration* (25 min)
- NTS, ADM recap and framework, nose-high unusual attitude, nose-low unusual attitude (explicitly tied back to spiral dive recovery), in-flight fire and smoke/fumes immediate actions

*IC Recreation* (25 min)
- IC delivers the identical brief; IT role-plays the assigned student capability
- IT confirms the IC draws the explicit connection between nose-low recovery and the spiral dive principle taught several lessons earlier — this is the clearest test of whether the IC is building a coherent syllabus in the student's mind, not teaching lessons in isolation
]
...
- *IT Feedback*: Correctness of nose-low recovery sequence and whether the spiral-dive connection was made explicit; fluency of fire/smoke memory-item teaching; quality of ADM coaching on the novel scenario.
- *Next Steps*: Confirm the IC has completed all 12 syllabus walkthrough lessons. Log the student capability played this session. Brief the IC on the structure of the upcoming consolidation pass (condensed re-brief + focused flight segment per lesson).
]

,standards_for_progression:[
- IC teaches nose-high and nose-low recovery correctly, explicitly connecting nose-low recovery to the earlier spiral dive principle
...
,homework:[
- No new reading — this is the final syllabus walkthrough lesson.
- Review the full walkthrough lesson list (Lessons 1–12) and identify, in the IC's own judgement, which lessons feel least secure — this self-assessment will help sequence the consolidation pass.
]
)
